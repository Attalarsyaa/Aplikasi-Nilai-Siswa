        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="?m=kelas&s=update" method="post">
                    ...
                    <div class="mb-2">
                        <input type="text" class="form-control"  name="capacity" value="<?= $r['capacity'] ?>" placeholder="Kapasitas Ruangan">
                    </div>
                    <div class="mb-2">
                        <input type="text" class="form-control"  name="fill" value="<?= $r['fill'] ?>" placeholder="Jumlah Siswa (Terisi)">
