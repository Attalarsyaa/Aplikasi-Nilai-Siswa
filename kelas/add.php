        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="?m=kelas&s=save" method="post">
                    ...
                    <div class="mb-2">
                        <input type="text" class="form-control"  name="capacity" placeholder="Kapasitas Ruangan">
                    </div>
                    <div class="mb-2">
                        <input type="text" class="form-control"  name="fill" placeholder="Jumlah Siswa (Terisi)">
                    </div>
                    <div class="mb-2">
